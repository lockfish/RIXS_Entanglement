...
class dimer_witness:
    ...
    QFI_denom       : Calculate the QFI denominator.
    calc_RIXS       : Calculate the RIXS spectra.
    """
    ...
    def QFI_denom(self, Q=None, pos=None, Gam_c=5., omega=None,
                    phi=0., thin=30., tth=90., pol=[(0, 0), (0, np.pi / 2.0)],
                    T=10.):
        """
        ...
        Parameters
        ----------
        Q : list of 3-element array/list
            Q vectors in unit of \AA^{-1}. It can either have the same size of thin or just one Q (default: None).
        pos : list of 3-element array/list
            Positions of the atoms (default: None).
        Gam_c : float
            Inverse core-hole lifetime in unit of eV (default: 5.).
        omega : 1d array or float
            Incident energy (default: None).
        phi : float
            Azimuthal angle in unit of degree (default: 0.).
        thin : 1d array or float
            Incident angle w.r.t. sample surface in unit of degree (default: 30.).
        tth : float
            Scattering angle in unit of degree  (default: 90).
        pol : list of 2-element turple
            X-ray polarization, (incident, emission), w.r.t the scattering plane
            (default: [(0, 0), (0, np.pi / 2.0)]).
        T : float
            Temperature in unit of Kelvin (default: 10).

        Returns
        -------
        den[pol,omega,thin] : 3d array
        """
        evals_i     = self.index('evals_i')
        evals_n_all = self.index('evals_n')
        T_abs_all   = self.index('T_abs')
        ...
        if not isinstance(pol, list):
            pol = [pol]
        if pos is None:
            pos = [[0., 0., 0.] for _ in range(len(evals_n_all))]
        if Q is None:
    ...
    def calc_RIXS(self, Q=None, pos=None, Gam_c=5., sigma=0.05, fraction=0.,
                    omega=None, eloss=None, eline=None,
                    phi=0., thin=30., tth=90., pol=[(0, 0), (0, np.pi / 2.0)],
                    T=10., tol=1e-3, ngs=None):
        """
        Calculate RIXS.
        ...
        Gam_c : float
            Inverse core-hole lifetime in unit of eV (default: 5.).
        sigma : float
            Sigma of PseudoVoigt profile (default: 0.05).
        fraction : float
            Fraction of PseudoVoigt profile (default: 0.).
        omega : 1d array or float
            Incident energy (default: None).
        eloss : 1d array
            Energy loss (default: None).
        phi : float
            Azimuthal angle in unit of degree (default: 0.).
        thin : 1d array or float
            Incident angle w.r.t. sample surface in unit of degree (default: 30.).
